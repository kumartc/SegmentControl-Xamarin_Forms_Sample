...
namespace SegmentControl.Controls
{
    public class SegmentControl : ContentView
    {
        public static readonly BindableProperty ItemSelectedProperty = BindableProperty.Create(nameof(ItemSelected), typeof(string), typeof(SegmentControl), null);
        public static readonly BindableProperty ChildrenProperty = BindableProperty.Create(nameof(Children), typeof(List<string>), typeof(SegmentControl), null);
        ...
        public static readonly BindableProperty SelectedLineColorProperty = BindableProperty.Create(nameof(SelectedLineColor), typeof(Color), typeof(SegmentControl), Color.Black);
        ...
        public static readonly BindableProperty AutoScrollProperty = BindableProperty.Create(nameof(AutoScroll), typeof(bool), typeof(SegmentControl), true);


        public static readonly BindableProperty SelectedItemChangedCommandProperty = BindableProperty.Create(nameof(SelectedItemChangedCommand), typeof(Command<string>), typeof(SegmentControl), default(Command<string>), BindingMode.TwoWay, null, SelectedItemChangedCommandPropertyChanged);

        static void SelectedItemChangedCommandPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var source = bindable as SegmentControl;
            if (source == null)
            {
                return;
            }
        ...
        NoScrollViewBar _mainLayout = new NoScrollViewBar() { VerticalOptions = LayoutOptions.Start, Orientation = ScrollOrientation.Horizontal };
